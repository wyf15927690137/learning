...
P4 describe and p4 diff

```
p4 describe -S -du 466626
p4 diff -du  //depot/sigrity/main/Install/cm/jenkins_utils/ExtractwithJson/MCADProductLists.json

# p4 diff pending and shelved
p4 diff //depot/sigrity/main/Install/cm/jenkins_utils/ExtractwithJson/ExtractReleaseFiles.bat@=466626
```
